"""
One-time / on-demand ingestion: reads geology & historical-record documents from
knowledge_base/, chunks them, embeds them, and stores them in the vector store.
Run this whenever you add new documents (see README for the CLI command).
"""
import os
