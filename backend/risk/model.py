"""
Lightweight, transparent weighted-scoring model as a stand-in for a trained
ML model. Structured so a real trained model (e.g. a saved scikit-learn
pipeline) can be dropped in later behind the same `score(features) -> float`
interface without touching risk/fusion.py.
"""
import os
import pickle
