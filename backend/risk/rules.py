"""
Deterministic, human-auditable threshold rules. This is the layer a safety
regulator / your project evaluator can read line-by-line and trust -- it does
NOT depend on the LLM/agent layer at all.
"""
