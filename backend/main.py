"""
FastAPI application entrypoint. Wires together: hardware -> sensors -> processing
-> risk -> database, running as a background polling loop, plus the REST API
(sensor/risk/alert/ai routes) for clients to query state and trigger explanations.
"""
import asyncio
import logging
import contextlib
